         ...
         <tr>
            ...
            <tr v-if="items.length === 0">
             ...
             <tr v-for="todo in items">
                <td><input id="oregano-1" type="checkbox" class="checkedBox"/>
                  <label for="oregano-1" class="checkedLabel">
                    {{todo.task}}</label></td>
               <td><label for="oregano-1" class="checkedLabel">
                 {{todo.deadline}}</label></td>
